...
# GPS config
PRODUCT_COPY_FILES += \
	device/friendly-arm/mini210/gps.xml:system/vendor/etc/gps.xml \
	device/friendly-arm/mini210/gps.conf:system/etc/gps.conf

# FriendlyARM support
PRODUCT_COPY_FILES += \
	device/friendly-arm/mini210/init.rc:root/init.rc \
	device/friendly-arm/mini210/init.mini210.sh:system/etc/init.mini210.sh \
	device/friendly-arm/mini210/fa_gpio_keys.kl:system/usr/keylayout/gpio-keys.kl \
	device/friendly-arm/mini210/fa_gpio_keys.kcm:system/usr/keychars/gpio-keys.kcm \
	device/friendly-arm/mini210/friendlyarm-ts-input.conf:system/etc/friendlyarm-ts-input.conf

$(call inherit-product, device/friendly-arm/mini210/device_base.mk)

# See comment at the top of this file. This is where the other
# half of the device-specific product definition file takes care
# of the aspects that require proprietary drivers that aren't
# commonly available
$(call inherit-product-if-exists, vendor/friendly-arm/mini210/device-vendor.mk)
