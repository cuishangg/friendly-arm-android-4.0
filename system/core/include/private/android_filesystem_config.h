...
static struct fs_path_config android_files[] = {
    { 00440, AID_ROOT,      AID_SHELL,     "ueventd*.rc" },
    ...
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/init.gprs-pppd" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/init.em770-pppd" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/ip-down" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/ip-down-ppp0" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/ip-up" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/ip-up-ppp0" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/ip-pre-up" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/ip-up-vpn" },
    { 00777, AID_ROOT,   AID_SHELL,  "system/etc/ppp/peers/*" },
