    ...
    void refreshViews() {
        ...
        if (mEthernetConnected) {
            ...
            label = "Ethernet Connected";
			   mContentDescriptionCombinedSignal = label;
        ...
        else if (!mDataConnected && !mWifiConnected && !mBluetoothTethered && !mEthernetConnected && !mWimaxConnected) {
	    ...
	    Slog.d(TAG, "ethernet will update mDataTypeIconId" + N);
            for (int i=0; i<N; i++) {
