...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private com.slsi.sec.android.HdmiService mHdmiService;
    private static boolean onFirstRef = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!onFirstRef) {
            onFirstRef = true;
            tvResolutionPreference.setValue(String.valueOf(FALLBACK_TV_RESOLUTION_VALUE));
        }
        ...
        mHdmiService = new com.slsi.sec.android.HdmiService();
        mHdmiService.initHdmiService();
